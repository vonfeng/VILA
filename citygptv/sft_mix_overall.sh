...
OUTPUT_DIR=/mnt/public/fengjie/model_zoo/citygptv-20241007-mix-v3
DATA_MIX=llava_instruct+sharegpt4v_gpt4_100k+citygptv_single+citygptv_img2text2img+citygptv_citywalk_vison+citygpt_citywalk+citygpt_cityqa+citygpt_vflan+citygpt_general
