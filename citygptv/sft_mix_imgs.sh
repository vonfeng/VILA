...
OUTPUT_DIR=/mnt/public/fengjie/model_zoo/citygptv-20241007-mix-v5
DATA_MIX=llava_instruct+citygptv_single+citygptv_img2text2img+citygpt_vflan+citygptv_multi+citygptv_text2img2text
