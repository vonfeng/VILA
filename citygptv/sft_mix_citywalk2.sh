...
OUTPUT_DIR=/data3/fengjie/model_zoo/citygptv-20241007-mix-citywalk-expand
DATA_MIX=llava_instruct+citygptv_citywalk_vison+citygpt_citywalk+citygpt_cityqa+citygpt_vflan+citygpt_general
GPUS=4,5,6,7
